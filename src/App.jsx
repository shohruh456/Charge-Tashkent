  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen bg-[#f6f8f7] text-slate-950 transition-colors dark:bg-[#07110d] dark:text-white">
        {isBooting && (
          <div className="site-loader fixed inset-0 z-[9999] grid place-items-center bg-[#f7faf8] dark:bg-[#07110d]" role="status" aria-live="polite" aria-label={t('loadingSite')}>
            <div className="text-center">
              ...
              <p className="mt-3 text-xs font-bold text-slate-400">{t('loadingSite')}</p>
            </div>
          </div>
        )}
        <Header />
